...
public class GameState {
    ...
    public GameState() {
        ...
        plataformas.add(new Plataforma(20, 720, 110, 30)); //Plataforma principal inicio
    ...
    public String toJson() {
        ...
        sb.append("]");  // ← Cierre correcto del array de lianas
    ...
    static class Fruit {
        ...
        String toJson(){
            return String.format(
                java.util.Locale.US,
                "{\"liana\":%d,\"altura\":%.1f,\"puntos\":%d}",
                lianaId, altura, puntos
            );
        }
    }
}
